...
function sumAndMultiply(a, b, c) { //eslint-disable-line
    ...
    var messagesum = a + " and " + b + " and " + c + " sum to " + adding + ".";
    //console.log(messagesum);
    //console.log(messagesum);
    var messageproduct = "The product of " + a + " and " + b + " and " + c + " is " + product + ".";
    return [adding, product, messagesum, messageproduct];
}
...
var message = sumArr + " was passed in as an array of numbers, and " + addArray + " is their sum" +'.';
console.log(message);
console.log("2,3,4 was passed in as an array of numbers, and 9 is their sum.");
return[addArray,message];
}
...
function multiplyAnyArray(dynamicArray) { //eslint-disable-line
    ...
    for (var i = 0; i<testDynamicArray.length; i++){
           var product = multiply(dynamicArray[i], product)[0];    
    }
    var message = "The numbers " + dynamicArray + " have a product of " + product + '.';  
    console.log(message);
    return [product, message];
}
